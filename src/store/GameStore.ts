...
import { GameStoreKey, GameStoreNumberKey, GameStoreValue, SaveKey, SaveValue, getStoreDefaultValue, getStoreKeys } from './GameStoreKey'
...
export class GameStore extends Phaser.Events.EventEmitter {
	...
	public saveValue<K extends SaveKey>(key: K, value: SaveValue<K>): void {
		this._storage?.saveValue(key, value).catch((error) => {
