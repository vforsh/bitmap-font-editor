...
export function initSentry() {
	...
	Sentry.init({
		...
		denyUrls: [/adnxs\.com/, /improvedigital\.com/, /imasdk\.googleapis\.com/, /innovid\.com/],
		beforeBreadcrumb,
		beforeSend,
	})
...
function beforeSend(event: Event, hint?: EventHint): PromiseLike<Event | null> | Event | null {
	...
	let regexs = [/game(\.[a-z0-9]{10})?\.js/g, /game(\.[a-z0-9]{10})?\.min\.js/g, /vendor\.min(\.[a-z0-9]{10})?\.js/g, /tweakpane\.min(\.[a-z0-9]{10})?\.js/g]
