...
export class Phaser3Extensions {
	...
	private static extendLoader() {
		...
		Phaser.Loader.LoaderPlugin.prototype.bitmapFontJson = function (key: string, textureURL: string | string[], fontDataURL: string, addToTexture?: string): Phaser.Loader.LoaderPlugin {
